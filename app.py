...
def registra_entrada_saida(form: RegistroSchema):
    ...
    try:        
        ...
        if registro and registro.ubs_id == form.ubs_id:
            #recuperando ubs para atualizar fila
            ubs = registro.ubs
            #testa se registro nao tem data de entrada
            if registro.data_entrada == None:
                #registra entrada e adiciona a fila da ubs            
            ...
            #se registro existe mas não é da mesma ubs, cria novo registro
            registro = None
            #caso não esteja na fila, cria novo registro e adiciona a fila da ubs
            registro  = Registro(
